import { modifierGroupService } from "./modifierGroup.service.ts";
    ...
    async getModifierGroups(req: Request, res: Response) {
        try {
            const modifierGroups =
                await modifierGroupService.getModifierGroups();
    ...
    async addModifierGroup(req: Request, res: Response) {
        ...
        try {
            const newModifierGroup =
                await modifierGroupService.addModifierGroup(input);
    ...
    async updateModifierGroup(req: Request, res: Response) {
        ...
        try {
            const updatedModifierGroup =
                await modifierGroupService.updateModifierGroup(id, input);
